...
#ifndef PROTOCOL_FORWARD_ERROR_CORRECTION_INTERNAL_H_
#define PROTOCOL_FORWARD_ERROR_CORRECTION_INTERNAL_H_
...
#endif  // PROTOCOL_FORWARD_ERROR_CORRECTION_INTERNAL_H_
