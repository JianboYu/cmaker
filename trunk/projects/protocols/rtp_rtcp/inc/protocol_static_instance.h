...
#ifndef PROTOCOL_STATICINSTANCETEMPLATE_H_
#define PROTOCOL_STATICINSTANCETEMPLATE_H_
...
static T* GetStaticInstance(CountOperation count_operation) {
  ...
  static Mutex* crit_sect(Mutex::Create());
  AutoLock lock(crit_sect);
...
#endif  // PROTOCOL_STATICINSTANCETEMPLATE_H_
