...
#ifndef PROTOCOL_COMMON_TYPES_H_
#define PROTOCOL_COMMON_TYPES_H_
...
#include "protocol_common_types_internal.h"

namespace protocol {

#define LOG(x) std::cerr
#define LOG_F(x) std::cerr
...
#endif  // PROTOCOL_COMMON_TYPES_H_
