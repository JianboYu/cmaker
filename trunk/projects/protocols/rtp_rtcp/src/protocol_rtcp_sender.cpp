...
#include "rtcp_packet/protocol_app.h"
#include "rtcp_packet/protocol_bye.h"
#include "rtcp_packet/protocol_compound_packet.h"
#include "rtcp_packet/protocol_extended_reports.h"
#include "rtcp_packet/protocol_fir.h"
#include "rtcp_packet/protocol_nack.h"
#include "rtcp_packet/protocol_pli.h"
#include "rtcp_packet/protocol_receiver_report.h"
#include "rtcp_packet/protocol_remb.h"
#include "rtcp_packet/protocol_rpsi.h"
#include "rtcp_packet/protocol_sdes.h"
#include "rtcp_packet/protocol_sender_report.h"
#include "rtcp_packet/protocol_sli.h"
...
RTCPSender::RTCPSender(
  ...
  critical_section_rtcp_sender_.reset(Mutex::Create());
}
...
int32_t RTCPSender::SendCompoundRTCP(
  ...
  PacketContainer container(transport_, event_log_);
  {
    ...
    while (it != report_flags_.end()) {
      ...
      //CHECK(builder_it != builders_.end()); //work aroud for complile
      if (it->is_volatile) {
...
bool RTCPSender::AddReportBlock(const FeedbackState& feedback_state,
  ...
  //CHECK_EQ(report_blocks_.find(ssrc), report_blocks_.end()); //work around for complile
