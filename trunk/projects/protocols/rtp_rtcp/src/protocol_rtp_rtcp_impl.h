...
#ifndef PROTOCOL_RTP_RTCP_IMPL_H_
#define PROTOCOL_RTP_RTCP_IMPL_H_
...
#include "protocol_packet_loss_stats.h"
...
class ModuleRtpRtcpImpl : public RtpRtcp, public IRTCPReceiverCallback,
 ...
 private:
  ...
  scoped_ptr<Mutex> critical_section_rtt_;
  int64_t rtt_ms_;
};

}  // namespace protocol

#endif  // PROTOCOL_RTP_RTCP_IMPL_H_
