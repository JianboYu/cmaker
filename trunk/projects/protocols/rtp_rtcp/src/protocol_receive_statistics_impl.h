...
#ifndef PROTOCOL_RECEIVE_STATISTICS_IMPL_H_
#define PROTOCOL_RECEIVE_STATISTICS_IMPL_H_
...
class StreamStatisticianImpl : public StreamStatistician {
 ...
 private:
  ...
  void UpdateCounters(const RTPHeader& rtp_header,
                      size_t packet_length,
                      bool retransmitted);
  void NotifyRtpCallback();
  void NotifyRtcpCallback();

  Clock* const clock_;
  scoped_ptr<Mutex> stream_lock_;
...
class ReceiveStatisticsImpl : public ReceiveStatistics,
 ...
 private:
  ...
  Clock* const clock_;
  scoped_ptr<Mutex> receive_statistics_lock_;
...
#endif  // PROTOCOL_RECEIVE_STATISTICS_IMPL_H_
