 ...
 */
#ifndef PROTOCOL_RTCP_PACKET_COMMON_HEADER_H_
#define PROTOCOL_RTCP_PACKET_COMMON_HEADER_H_
...
class CommonHeader {
 public:
  ...
  bool Parse(const uint8_t* buffer, uint32_t size_bytes);
...
#endif  // PROTOCOL_RTCP_PACKET_COMMON_HEADER_H_
