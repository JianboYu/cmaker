...
bool RtpExtension::IsSupportedForAudio(const std::string& uri) {
  return uri == protocol::RtpExtension::kAbsSendTimeUri ||
         uri == protocol::RtpExtension::kAudioLevelUri ||
         uri == protocol::RtpExtension::kTransportSequenceNumberUri;
}

bool RtpExtension::IsSupportedForVideo(const std::string& uri) {
  return uri == protocol::RtpExtension::kTimestampOffsetUri ||
         uri == protocol::RtpExtension::kAbsSendTimeUri ||
         uri == protocol::RtpExtension::kVideoRotationUri ||
         uri == protocol::RtpExtension::kTransportSequenceNumberUri ||
         uri == protocol::RtpExtension::kPlayoutDelayUri;
}
