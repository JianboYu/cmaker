...
#include "protocol_fec_private_tables_bursty.h"
#include "protocol_fec_private_tables_random.h"

namespace {
using protocol::fec_private_tables::kPacketMaskBurstyTbl;
using protocol::fec_private_tables::kPacketMaskRandomTbl;
